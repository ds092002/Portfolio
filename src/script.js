...
let typeScriptWebsite = document.querySelector(".TypeScript-website");
...
furnitureWebsite.addEventListener("click", () => {
    websiteName.innerText = "Furniture Website";
    clientName.innerText = "Skill Code"
    languages.innerText = "Express Js";
    preview.innerText = "Funrniture App";
    preview.addEventListener("click", () => {
        open("https://github.com/ds092002/Node_project");
    });
...
budgetAppWebsite.addEventListener("click", () => {
    websiteName.innerText = "Budget App";
    clientName.innerText = "Skill Code"
    languages.innerText = "html,css, Javascript";
    preview.innerText = "Budget App page";
    preview.addEventListener("click", () => {
        open("https://github.com/ds092002/d_js/blob/main/my%20projects/budget.html");
    });
